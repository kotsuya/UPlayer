...
class AssetPlaybackManager: NSObject {
    ...
    func updateGeneralMetadata() {
        ...
        let album = AVMetadataItem.metadataItems(from: urlAsset.commonMetadata, withKey: AVMetadataKey.commonKeyAlbumName, keySpace: AVMetadataKeySpace.common).first?.value as? String ?? asset.albumName
